...
static char *physNames [64] = 
{
  ...
  "     (DC POWER) 3.3v", "5v DC POWER         ",
  "       (SDA.1)GPIO02", "5v DC POWER         ",
  "       (SCL.1)GPIO03", "0v GROUND           ",
  "   (GPIO_GCLK)GPIO04", "GPIO14(TXD0)        ",
  "           GROUND 0v", "GPIO15(RXD0)        ",
  "   (GPIO_GEN0)GPIO17", "GPIO18(GPIO_GEN1)   ",
  "   (GPIO_GEN2)GPIO27", "0v GROUND           ",
  "   (GPIO_GEN3)GPIO22", "GPIO23(GPIO_GEN4)   ",
  "     (DC POWER) 3.3v", "GPIO24(GPIO_GEN5)   ",
  "    (SPI_MOSI)GPIO10", "0v GROUND           ",
  "    (SPI_MISO)GPIO09", "GPIO25(GPIO_GEN6)   ",
  "     (SPI_CLK)GPIO11", "GPIO08(SPI_CE0_N)   ",
  "           GROUND 0v", "GPIO07(SPI_CE1_N)   ",
  "(I2C ID EEPROM)ID_SD", "ID_SC(I1C ID EEPROM)",
  "              GPIO05", "0v GROUND           ",
  "              GPIO06", "GPIO12              ",
  "              GPIO13", "0v GROUND           ",
  "              GPIO19", "GPIO16              ",
